...
/*	for(int i=0; i<5; i++)
	{
	list1.insertBack(int(i+1));
	}
	list1.print(cout);
	list1.reverse();
	list1.print(cout);
        list1.reverseNth(int(4));
		list1.print(cout);*/
        testReverse();
        testReverseNth();
        }
...
/*	for(int i=0; i<5; i++)
        ...
        else if (args[1] == "merge")
	{
	  /*       for(int i=0; i<1; i++)
	{
	list2.insertBack(int(i+1));
	}
         for(int i=0; i<1; i++)
	{
	list1.insertBack(int(i+2));
	}
	list1.print(cout);
        list2.print(cout);
...
display first->data
display second->data
display first->prev->data
display curr->data
display sec_curr->data
display temp->data
display curr->next->data
